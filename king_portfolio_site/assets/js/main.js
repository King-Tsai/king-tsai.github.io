(function () {
  ...
  function render() {
    ...
    skillTags.innerHTML = '';
    (data.skills || []).forEach((skill) => skillTags.appendChild(create('span', 'tag', skill)));
    ...
    certList.innerHTML = '';
    (data.certifications || []).forEach((cert) => certList.appendChild(create('span', 'cert reveal', cert)));
